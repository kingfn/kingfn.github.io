...
g.rankShow(b+1);},100);};d.onerror=function(){g.showin(a);g.rankShow(b+1);};}}else{setTimeout(function(){g.showin(a);g.rankShow(b+1);},100);}}else{if(this.config.callback){this.config.callback();
